...
rayaGreetings =
  "Selamat Hari Raya Aidilfitri! Maaf Zahir dan Batin kepada [[NAME]]"; // templating

const content =
  "Hello world, this is a note produces by the core module fs in node.js";
...
for (let i = 0; i < names.length; i++) {
  ...
  // write to file
  fs.writeFile(
    `./output/${name}-raya-greetings.txt`,
    greeting,
    function (error) {
      if (error) {
        console.error("Error writing file");
